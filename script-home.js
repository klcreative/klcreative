/* Version: 2026-0121-PARALLAX - with GA4 Event Tracking */
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ========== 視差滾動效果 + Scale 階段效果 ==========
    const PARALLAX_SPEED = 0.5; // 背景滾動速度 (0.5 = 正常速度的一半)
    ...
    function updateParallaxAndScale() {
        ...
        contentSections.forEach(section => {
            ...
            // === 1. 視差滾動效果 (translateY) ===
            // 計算背景相對於區塊頂部的偏移量
            const offsetY = (scrollY - sectionTop) * (1 - PARALLAX_SPEED);
            ...
            // === 3. 合併 transform: scale + translateY ===
