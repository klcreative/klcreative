/* Version: 2025-1229-1600 - Auto Adaptive */
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 使用自動偵測的路徑前綴
    const images = [
        `${pathPrefix}image02/about08.jpg`,
        `${pathPrefix}image02/about09.jpg`,
        `${pathPrefix}image02/about10.jpg`,
        `${pathPrefix}image02/about11.jpg`
    ];
