/* Version: 2026-1115-1300 - Auto Adaptive */
document.addEventListener('DOMContentLoaded', () => {
    // =========================================
    // 自動偵測路徑前綴
    // =========================================
    const pathPrefix = document.documentElement.lang === 'en' ? '../../about/' : '';
    ...
    // 使用自動偵測的路徑前綴 - 改為 webp
    const images = [
        `${pathPrefix}image02/about08.webp`,
        `${pathPrefix}image02/about09.webp`,
        `${pathPrefix}image02/about10.webp`,
        `${pathPrefix}image02/about11.webp`
    ];
    ...
    function showLightbox(index) {
        ...
        lightboxImage.alt = lang === 'zh-Hant' 
            ? `KL Creative 作品展示 ${currentImageIndex + 1}`
            : `KL Creative portfolio ${currentImageIndex + 1}`;
    ...
    function closeLightbox() {
        ...
        const triggerButton = galleryItems[currentImageIndex];
        if (triggerButton) {
            triggerButton.focus();
        }
    }
