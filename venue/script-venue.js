...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // =========================================
    // èƒŒæ™¯è¦–å·®å‹•æ…‹æ•ˆæžœ - åƒè€ƒ catering æ¨£å¼
    // =========================================
    ...
    // =========================================
    // "Create" æ¨™é¡Œæ–‡å­—æ·¡å…¥å‹•ç•«(åœ¨ scroll è¦–è¦ºå…§)
    // =========================================
    ...
    // =========================================
    // Layout Section ç”±ä¸Šåˆ°ä¸‹æ»‘å…¥å‹•ç•«
    // =========================================
    ...
    // =========================================
    // Seating Section æ»‘å…¥å‹•ç•« (å³åˆ°å·¦)
    // =========================================
    ...
    // =========================================
    // Meeting Section æ»‘å…¥å‹•ç•« (å·¦åˆ°å³)
    // =========================================
    ...
    // =========================================
    // Gallery Section - å·²å–æ¶ˆè¦–å·®æ•ˆæžœ
    // ç›¸ç‰‡ç‰†ä¸å†æœ‰æ»¾å‹•å‹•ç•«,ç›´æŽ¥é¡¯ç¤º
    // =========================================
    // (å·²ç§»é™¤ gsap.from('.gallery-section') å‹•ç•«)

    // =========================================
    // ç…§ç‰‡ç‡ˆç®±åŠŸèƒ½ (ç›¸ç‰‡ç‰†)
    // =========================================
    ...
    // è‡ªå‹•åµæ¸¬ç•¶å‰é é¢æ˜¯ä¸­æ–‡ç‰ˆé‚„æ˜¯è‹±æ–‡ç‰ˆ
    const currentPath = window.location.pathname;
    const isEnglishVersion = currentPath.includes('/en/');
    
    // æ ¹æ“šç‰ˆæœ¬è¨­å®šæ­£ç¢ºçš„åœ–ç‰‡è·¯å¾‘
    const imageBasePath = isEnglishVersion 
        ? '../../venue/image04/venue'  // è‹±æ–‡ç‰ˆè·¯å¾‘
        : '../venue/image04/venue';    // ä¸­æ–‡ç‰ˆè·¯å¾‘
    ...
    function updateLightboxImage() {
        ...
        lightboxImage.src = `${imageBasePath}${imageNum}.jpg`;
        const lang = document.documentElement.lang;
        lightboxImage.alt = lang === 'zh-Hant' 
            ? `å ´åœ°ç§Ÿå€Ÿä½œå“ ${currentImageIndex + 1}` 
    ...
    const equipmentImagePaths = [
        'venue-equipment-sofa.jpg',
        'venue-equipment-mic.jpg',
        'venue-equipment-projector screen.jpg',
        'venue-equipment-projector.jpg',
        'venue-equipment-speaker.jpg',
        'venue-equipment-karaoke.jpg'
    ];
    ...
    // ä¿®æ”¹ç‡ˆç®±å°ŽèˆªæŒ‰éˆ•ä»¥æ”¯æŒè¨­å‚™åœ–ç‰‡
    if (lightboxPrev) {
