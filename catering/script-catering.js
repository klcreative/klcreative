/* Version: 2025-1226-0110 - Fixed for both CN & EN */
document.addEventListener('DOMContentLoaded', () => {
    ...
    const imageBasePath = isEnglishVersion 
        ? '../../catering/image03/catering'  // 英文版路徑
        : 'image03/catering';                // 中文版路徑
    ...
    function updateLightboxImage() {
        const imageNum = String(currentImageIndex + 8).padStart(2, '0');
        lightboxImg.src = `${imageBasePath}${imageNum}.jpg`;
        const lang = document.documentElement.lang;
        lightboxImg.alt = lang === 'zh-Hant' 
            ? `餐飲外燴作品 ${currentImageIndex + 1}` 
            : `Catering work ${currentImageIndex + 1}`;
    }
