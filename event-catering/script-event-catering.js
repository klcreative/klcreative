...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ========================================= 標題文字淡入動畫 =========================================
    gsap.from('.content .center .title-top .hero-title-top', {
        scrollTrigger: {
            trigger: '.hero',
            start: 'top center',
            end: 'center center',
    ...
    // ========================================= Title Section 淡入動畫 =========================================
    gsap.from('.title-section .title-main', {
        scrollTrigger: {
    ...
    // ========================================= Clients Section 淡入動畫 =========================================
    gsap.from('.clients-section .clients-title', {
        scrollTrigger: {
    ...
    function updateLightboxImage() {
        ...
        lightboxImage.alt = lang === 'zh-Hant' 
            ? `活動餐飲作品 ${currentImageIndex + 1}` 
            : `Event catering work ${currentImageIndex + 1}`;
    }
